# Mockup sync report - kerjasama/create-success

- Source capture: `mockups/raw/kerjasama-create-success/SEVIMA Platform - Detail Kerjasama Create Success.html`
- Generated mockup: `mockups/pages/kerjasama/create-success.html`
...
- Links pointing to other app pages that already have a mockup built: **8** - rewritten to open that mockup directly (navbar tabs, "Tambah"/Edit/Detail buttons, etc. actually navigate, same as production).
- Links with no matching mockup yet: **19** - left as `#` for now. Capture one of these pages next and re-run the build (any slug) to wire them up automatically, on this page AND every other mockup that links to it:
  ...
  - `/v2/kerjasama/data-kerjasama/101/edit`
  - `/v2/kerjasama/evaluasi-kerjasama/101`
  - `/v2/kerjasama/jenis-dokumen`
  - `/v2/kerjasama/kegiatan`
  - `/v2/kerjasama/kegiatan-kerjasama/101`
  - `/v2/kerjasama/kegiatan/create`
  - `/v2/kerjasama/kriteria-mitra`
  - `/v2/kerjasama/laporan-kerjasama`
  - `/v2/kerjasama/mitra`
  - `/v2/kerjasama/mitra/30`
...
- Livewire/Alpine attributes stripped: 3
...
- Matched known QUANTUM classes: **200**
