# Mockup sync report - kerjasama/index

- Source capture: `mockups/raw/dashboard/SEVIMA Platform - Dashboard.html`
- Generated mockup: `mockups/pages/kerjasama/index.html`
...
Charts: 4 functional script(s) vendored locally (Chart.js + datalabels plugin + chart-settings) and the real inline chart-init script (with its actual data) was preserved - charts render for real, not a static image.
...
- Matched known QUANTUM classes: **162**
- `sym-*` icon classes referenced: **0**
- Bootstrap-style utility classes: **2**
- `qn-*` classes NOT found in local QUANTUM copy (possible drift): **1**
- Other/unclassified (likely app-specific, one-off): **3**
