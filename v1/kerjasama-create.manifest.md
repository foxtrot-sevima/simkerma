# Mockup sync report - kerjasama/create

- Source capture: `mockups/raw/kerjasama-create/SEVIMA Platform - Kerjasama Create.html`
- Generated mockup: `v1/kerjasama-create.html`
...
- Links pointing to other app pages that already have a mockup built: **20** - rewritten to open that mockup directly (navbar tabs, "Tambah"/Edit/Detail buttons, etc. actually navigate, same as production).
...
- Livewire/Alpine attributes stripped: 223
...
- Matched known QUANTUM classes: **227**
...
- Other/unclassified (likely app-specific, one-off): **14**
