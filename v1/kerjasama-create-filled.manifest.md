...
- Links pointing to other app pages that already have a mockup built: **24** - rewritten to open that mockup directly (navbar tabs, "Tambah"/Edit/Detail buttons, etc. actually navigate, same as production).
